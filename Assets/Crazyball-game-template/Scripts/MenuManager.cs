...
public class MenuManager : MonoBehaviour {
	...
	void ReportGameStarted() {
		AndroidJavaClass unityCallMappingClass = new AndroidJavaClass("com.unity3d.player.UnityCallMapping");
		AndroidJavaObject mapperInstance = unityCallMappingClass.GetStatic<AndroidJavaObject>("instance");
		if (mapperInstance == null) {
			return;
		}
		mapperInstance.Call("passStringValue", "someTest");
	}
